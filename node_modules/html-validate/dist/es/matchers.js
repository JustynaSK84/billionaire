...
import { H as HtmlValidate, m as TokenType } from './core.js';
import 'fs';
...
async function toBeValid(actual) {
...
async function toBeInvalid(actual) {
    const report = await actual;
    if (report.valid) {
        return {
            pass: false,
...
async function toHaveError(actual, ruleId, message, context) {
    const report = await actual;
